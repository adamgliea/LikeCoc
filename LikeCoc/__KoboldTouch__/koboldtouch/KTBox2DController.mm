...
-(void) performAddBody:(KTBox2DBody*)physicsBody
{
	...
	// +1 the physicsBody, the userData member may be the only reference to the body!
	body->SetUserData((__bridge_retained void*)physicsBody);
...
-(void) performRemoveBody:(KTBox2DBody*)physicsBody
{
	...
	// -1 the physicsBody (userData), using CFBridgingRelease to not have to assign the return value, does the same as: (__bridge_transfer void*)
	CFBridgingRelease(physicsBody.box2dBody->GetUserData());
